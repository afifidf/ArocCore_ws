...
class PIDControl:
    ...
    def getOutput(self):
        # ============================================================
        # [FIX] Clamp output ke range [OutRangeMin, OutRangeMax].
        # Sebelumnya kondisi: Output < OutRangeMin → return OutRangeMin (BENAR)
        # tapi ditulis dalam bentuk ternary bersarang yang sulit dibaca dan
        # rawan salah baca. Ditulis ulang menjadi eksplisit + np.clip agar
        # jelas dan benar secara logika.
        # ============================================================
        import numpy as np
        return float(np.clip(self.Output, self.OutRangeMin, self.OutRangeMax))
